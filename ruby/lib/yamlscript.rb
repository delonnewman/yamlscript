...
class YAMLScript
  ...
  def_delegators 'self.class', :load_ys_to_json, :graal_create_isolate, :graal_tear_down_isolate
  private :load_ys_to_json, :graal_create_isolate, :graal_tear_down_isolate
end
